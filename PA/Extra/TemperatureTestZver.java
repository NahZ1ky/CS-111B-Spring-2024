...
public class TemperatureTestZver
{
   public static void main(String[] args)
   {
	...
	System.out.println();
	TemperatureZver t1 = new TemperatureZver();
	...
	System.out.println("Test case 3: constructor with just"
		+ " temperature.");
	TemperatureZver t2 = new TemperatureZver(20.5);
 	System.out.println();
	...
	System.out.println();
 	...
 	System.out.println();
 	TemperatureZver t3 = new TemperatureZver('F');
 	t3.writeOutput();
 	System.out.println();
 	System.out.println("Hit 'y' to continue.");
 	System.out.println();
    ...
    System.out.println();
 	System.out.println("Verify 0 degrees C.");
 	System.out.println();
 	TemperatureZver t4 = new TemperatureZver('C');
 	t4.writeOutput();
 	System.out.println();
 	System.out.println("Hit 'y' to continue.");
 	System.out.println();
	...
	System.out.println("Test case 6: constructor with"
 	...
 	System.out.println();
 	TemperatureZver t5 = new TemperatureZver(-51.2, 'F');
 	t5.writeOutput();
 	System.out.println();
 	System.out.println("Hit 'y' to continue.");
 	System.out.println();
